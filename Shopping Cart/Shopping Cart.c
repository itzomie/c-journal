...
the following program is an example how stack of cart is carried out by adding and removal of items */
//Shopping Cart System

#include<stdio.h>
#define mrow 10
#define mcol 10
int Add_item(int t[mrow][mcol],int e[mrow][mcol],int ); //function decleration area
