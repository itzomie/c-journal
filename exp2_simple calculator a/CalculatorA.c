...
the following program demonstrates the implementation of simple calculator which performs basic operations like addition
subtraction, multiplication and division.
The following program demonstrates the use of pointer to the function*/
...
int main()
{
    ...
    float (*ptr)(float,float); //pointer to  add(),sub(),mul(),div() function
    void (*ptr1)(char,float,float,float); //pointer to display()
    ptr1=display;
    ...
    getchar();
    choice = getchar();
    switch(choice) //entering the choice
    {
        case'+' :
            ptr=add;
            break;
